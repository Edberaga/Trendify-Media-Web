      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            We offer a comprehensive range of creative services <br/>to help your <span className='primary-text'>brand succeed</span>
          </p>
        </motion.div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="p-6 py-10 bg-card rounded-lg shadow-lg text-center"
            >
        ...
        <div className="flex justify-center mt-12">
          <motion.button
            ...
            className="px-6 py-3 btn-primary hover:bg-primary text-primary-foreground rounded-lg transition-colors"
          >
